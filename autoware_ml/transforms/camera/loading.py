    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            normalize_to_unit: Whether to divide pixel values by ``255``. Must
                match the scale of the mean/std a downstream
                ``NormalizeMultiviewImage`` applies: keep pixels in [0, 255]
                for 0-255-scale ImageNet statistics.
